...
- [WiP - GitHub setup](github_setup.md): provides instructions on setting up GitHub for your projects and repositories, including initial configuration and settings.
- [WiP - Tips and tricks](WiP_tips_and_tricks.md): shares tips and tricks to help with coding, Code Review and development workflow overall, simplified checklists, etc.
